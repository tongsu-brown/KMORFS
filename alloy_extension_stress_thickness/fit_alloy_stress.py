...
# IMPORTANT: Pure elements MUST be listed before alloys!
...
# Number of pure elements at the start of MATERIALS list
# (used for alloy blending — pure element A0, B0, l0 are blended for alloys)
N_PURE_ELEMENTS = 4
